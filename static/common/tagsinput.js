...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.placeholderText = element.hasAttribute('placeholder') ? this.$element.attr('placeholder') : 'X';
    ...
    this.$input = $('<input class="' + this.class + '" type="' + this.type + '" name="' + this.name + '" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
